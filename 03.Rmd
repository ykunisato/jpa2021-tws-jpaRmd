...
それでは，早速お手持ちのWindowsパソコンにDockerを導入しましょう（Macは次の[「4 事前準備（Mac編）」](https://ykunisato.github.io/jpa2021-tws-jpaRmd/04.html)をご覧ください）。なお，　Dockerを使うにあたって，15GBくらいハードディスクに余裕があると良いかと思います。
...
```
docker run -e PASSWORD=paper -p 8787:8787 -v "%cd%":/home/rstudio -d --name paper ykunisato/paper-r:4.1.0
```
